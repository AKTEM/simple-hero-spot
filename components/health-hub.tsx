...
import { Clock, Eye, User, Heart, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <section className="space-y-8">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1 h-1 bg-green-600 rounded-full ml-4"></div>
      </div>

      <div className="bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-950 dark:to-teal-950 rounded-xl p-6 mb-8">
        <div className="text-center">
          <Heart className="w-12 h-12 text-green-600 mx-auto mb-3" />
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
            Your Guide to Wellness & Healthy Living
          </h3>
        ...
        {articles.length > 3 && (
          <>
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white px-8 py-3 flex items-center space-x-2 mx-auto"
            >
              <span>{showAll ? 'Show Less' : 'View All Health Articles'}</span>
              {showAll ? (

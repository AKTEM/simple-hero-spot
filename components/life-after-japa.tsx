...
import { Clock, Eye, User, Globe, ChevronDown, ChevronUp } from 'lucide-react';
import { TransformedPost } from '@/lib/wordpress';

interface LifeAfterJapaProps {
  articles: TransformedPost[];
}

export function LifeAfterJapa({ articles }: LifeAfterJapaProps) {
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950 dark:to-pink-950 rounded-xl p-6 mb-8">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
            Thriving Abroad: Stories & Tips
          </h3>
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Real experiences, practical advice, and inspiring stories from those who've made the move. 
            Navigate your new life abroad with confidence.
          </p>
        </div>
      </div>
      ...
      <div className="text-center">
        {articles.length > 3 && (
          <>
            ...
            >
              <span>{showAll ? 'Show Less' : 'View All Life After Japa'}</span>
              {showAll ? (
